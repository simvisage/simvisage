    ...
    def eval(self):
        ...
        while t_n1 <= self.t_max - self.d_t:
            ...
            while k <= self.k_max:
                ...
                R, K, eps, sig, xs_pi, alpha, z, w, D = self.ts.get_corr_pred(
...
#                 print 'r', np.linalg.norm(R)
        ...
        return U_record, F_record, sf_record, np.array(t_record), eps_record, sig_record, w_record, D_record
...
# BCDof(var='u', dof=n_dofs - 1, value=2.5, time_function=tf)]
    ...
    U_record, F_record, sf_record, t_record, eps_record, sig_record ,  w_record = tl.eval()
