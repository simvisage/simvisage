...
class GaussRandomField( HasTraits ):
    ...
    def _get_random_field( self ):
        ...
        return reshape( scaled_ydata, len( self.xgrid ) )



if __name__ == '__main__':
    rf = GaussRandomField( lacor = 6. , xgrid = linspace( 0, 100., 100 ) , nsim = 1 , stdev = 1. )
    x = rf.xgrid
    p.plot( x, rf.random_field )
    p.show()
