...
from etsproxy.traits.api import HasTraits, cached_property, \
    Float, Property, Instance, List, Array, Tuple, Bool, implements
...
class CompositeCrackBridgeGf(HasTraits):
    ...
    cont_fibers = Property(Instance(CrackBridgeContFibersGf), depends_on = 'reinforcement_lst+,Ll,Lr,E_m,w')
    @cached_property
    ...
    short_fibers = Property(Instance(CrackBridgeShortFibersGf), depends_on = 'reinforcement_lst+,E_m,w')
    @cached_property
