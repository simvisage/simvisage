...
#    label = Str('dog bone tensile test')
    ...
    width = Float(0.10, unit='m', input=True, table_field=True,
                  auto_set=False, enter_set=True)
    gauge_length = Float(0.35, unit='m', input=True, table_field=True,
                         auto_set=False, enter_set=True)
    age = Int(27, unit='d', input=True, table_field=True,

              auto_set=False, enter_set=True)
    '''Age of the concrete at the time of testing.
    '''
    n_rovings = Float(8, unit='-', input=True, table_field=True,
                  auto_set=False, enter_set=True)
...
#        concrete_mixture_key = 'Pagel_TF10'
        concrete_mixture_key = 'Pagel_TF10_Leipzig'
