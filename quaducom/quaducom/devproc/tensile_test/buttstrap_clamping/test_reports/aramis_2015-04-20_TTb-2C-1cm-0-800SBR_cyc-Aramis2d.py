...
if __name__ == '__main__':
    ...
    # Aramis2d - frontview
    #------------------------
#     test_file = 'TTb-2C-1cm-0-800SBR-V2_cyc-Aramis2d.DAT'
#     test_file = 'TTb-2C-1cm-0-800SBR-V3_cyc-Aramis2d.DAT'
#     test_file = 'TTb-2C-1cm-0-800SBR-V5_cyc-Aramis2d.DAT'

    # monotonic loading:
#     test_file = 'TTb-2C-1cm-0-800SBR-V1_Aramis2d.DAT'
#     start_time_aramis = 744.

    # cyclic loading (n=10^5 cycles):
    test_file = 'TTb-2C-1cm-0-800SBR-V4_cyc-Aramis2d.DAT'
    start_time_aramis = -4.

#     scale_data_factor = 1.195  #  based on tensile test specimen width ( = 100mm)
#     res_key = 'Xf15s1-Yf15s4'

    scale_data_factor = 1.208  #  based on tensile test specimen width ( = 100mm)
    res_key = 'Xf15s13-Yf15s13'

    #-------------------------------------------
    # specify parameters for aramis_cdt
    #-------------------------------------------
    crack_detaction_step = 195  # last step before rupture
    ...
    #-------------------------------------------
    n_px_specimen_width = 1200  # [px] number of px covering the specimen width for given png-file
    l_real = 120  # [mm] real width of tensile test specimen
...
#     e_run.aramis_field_data.top_j = 190
#     e_run.aramis_field_data.bottom_j += 200
