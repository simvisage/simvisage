...
if __name__ == '__main__':
    ...
    # Aramis2d - frontview
    #------------------------
     test_files = ['TTb-2C-1cm-0-800SBR-V1_Aramis2d.DAT',
                  'TTb-2C-1cm-0-800SBR-V2_cyc-Aramis2d.DAT',
                  'TTb-2C-1cm-0-800SBR-V3_cyc-Aramis2d.DAT',
                  'TTb-2C-1cm-0-800SBR-V4_cyc-Aramis2d.DAT',
                  'TTb-2C-1cm-0-800SBR-V5_cyc-Aramis2d.DAT']
