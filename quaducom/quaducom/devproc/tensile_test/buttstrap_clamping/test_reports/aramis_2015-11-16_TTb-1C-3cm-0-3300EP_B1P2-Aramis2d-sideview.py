...
if __name__ == '__main__':
    ...
    test_file_path = os.path.join(simdb.exdata_dir,
                                  ...
                                  '2015-11-16_TTb-1C-3cm-0-3300EP_B1P2-Aramis2d-sideview',
                                  )

    #------------------------
    # Aramis2d - sideview
    #------------------------
    test_file = 'TTb-1C-3cm-0-3300EP-V3_B1-Aramis2d-sideview.DAT'
    res_key = 'Xf15s1-Yf15s1'
    scale_data_factor = 1.321  # based on tensile specimen thickness (=30 mm)
    start_time_aramis = 0.
