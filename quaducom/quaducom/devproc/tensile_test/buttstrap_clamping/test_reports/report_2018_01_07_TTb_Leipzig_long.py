...
#n_rov_list = [10, 10]
color_list = ['blue', 'deepskyblue','green','palegreen','red',]
linestyle_list = ['-', '-', '-', '-', '-',]
plot_asc_list = [1, 1, 1, 1, 1,]

#a_roving_list = [3.62, 3.62, 3.62, 3.62, 3.62]
label_cutoff = [1, 1, 1, 1, 1]  # cutoff long label names at the end for cleaner legend display
