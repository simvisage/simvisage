...
if __name__ == '__main__':
    ...
    # Aramis2d - frontview
    #------------------------
    #test_file = 'TTb-6c-2cm-0-TU-V2.DAT'
    test_file = 'TTb-4c-2cm-0-TU-V2.DAT'
    start_time_aramis = 0.

    # based on tensile test specimen width ( = 100mm)
    scale_data_factor = 0.8
    res_key = 'Xf15s13-Yf15s13'

#     scale_data_factor = 1.40  # based on real specimen width of the tensile tests with SBR textile (= 96 mm)
#     res_key = 'Xf15s13-Yf15s13'

    #-------------------------------------------
    # specify parameters for aramis_cdt
    #-------------------------------------------
    crack_detection_step = -1  # last step (not used if 'current_step'=True)
    crack_detection_current_step = True
    ...
    e_run = ExpTTAramis2d(data_file=os.path.join(test_file_path, test_file),
                          ...
                          delta_t_aramis=0,
                          crack_detection_current_step=crack_detection_current_step,
