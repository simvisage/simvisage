...
if __name__ == '__main__':
    ...
    # Aramis2d - frontview
    #------------------------
    # NOTE: DAT/CSV-TEST FILE for test 'V2_cyc' is MISSING!
    # (as temporary work around use a COPY OF V1 as dummy file in order to display aramis data)!!!
    # @todo: replace test 'V2_cyc' by test 'V3_cyc' (n=10^6) instead!!!
    #
    test_file = 'TTb-2C-14mm-0-3300EP-V2_cyc-Aramis2d.DAT'
#     test_file = 'TTb-2C-14mm-0-3300EP-V3-alles_cyc-Aramis2d.DAT' #@todo: run aramis evaluation!
    start_time_aramis = 0.  # check offset?
    scale_data_factor = 1.332  # for tensile specimen width (=110 mm)
