...
if __name__ == '__main__':
    ...
    #-------------------------------------------
    test_file = 'BT-1C-55mm-0-3300EP-V2_S4P2(13)-cyc-Aramis2d.DAT'
...
#     res_key = 'Xf15s13-Yf15s13'
    ...
    #-------------------------------------------
    start_time_aramis = 2
    crack_detaction_step = 292  # last step before rupture
    integ_radius = 3  # radius used for crack detection
    integ_radius_crack = 6  # radius used for calculation of displacement jumps (=crack width)
    ddd_ux_avg_threshold = 0.000001
    ddd_ux_threshold = 0.000001
    dd_ux_avg_threshold = -5e-08
    dd_ux_threshold = -5e-08
