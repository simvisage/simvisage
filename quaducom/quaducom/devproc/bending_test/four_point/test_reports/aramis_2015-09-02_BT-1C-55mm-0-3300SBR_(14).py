...
Script evaluating the displacement jumps (= crack width) in the four point bending test
'''
...
if __name__ == '__main__':
    ...
    #-------------------------------------------
    test_file = 'BT-1C-55mm-0-3300SBR-V2_S4P2(14)-Aramis2d.DAT'
...
#     res_key = 'Xf15s13-Yf15s13'
    ...
    #-------------------------------------------
    start_time_aramis = 1
    crack_detaction_step = 179  # after this step was unloading branch
    ...
    dd_ux_avg_threshold = -0.000001
    dd_ux_threshold = -0.000001
