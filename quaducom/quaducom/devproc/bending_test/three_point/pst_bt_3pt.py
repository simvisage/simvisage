...
#        sim_model.tloop.eval()
    ...
    if do == 'validation':
        ...
        # pstudy: thickness
        #
        pst_study_list = [ 0.020, 0.019, 0.018, 0.017, 0.021, 0.022, 0.023 ]

        # pstudy: shape_z
        #
#        pst_study_list = [ 3, 6, 8 ]

        # pstudy: n_mp
        #
#        pst_study_list = [ 6, 12, 30 ]
        
        # pstudy: calibration test
        #
#        pst_study_list = [ 'TT-12c-6cm-0-TU-SH2F-V3_a23d_nu02_s100' , 'TT-12c-6cm-TU-SH1F-V1' ]
...
#        st_study_list = [ PhiFnGeneral, PhiFnGeneralExtended, PhiFnGeneralExtendedExp ] 
        ...
        for pst_param in pst_study_list:
...
#            sim_model.phi_fn_class = pst_param
            ...
            if test_series == 'BT-6c':
#                ex_path_V1 = os.path.join(simdb.exdata_dir, 'bending_tests', 'three_point', '2013-07-02_BT-6c-2cm-0-TU_bs4',
...
#                                       'BT-6c-2cm-0-TU-V3_bs4.DAT')
                ...
                tests = [ ex_path_V1, ex_path_V2, ex_path_V3 ]
                for ex_path in tests:
                    ex_run = ExRun(ex_path)
...
#            p.plot(trace.xdata, trace.ydata, color='red')
        ...
        if test_series == 'BT-6c':
            ...
            tests = [ 
#                     ex_path_bs4_V1, 
                     ex_path_bs4_V2,  # ex_path_bs4_V3,
#                     ex_path_bs5_V1,  # ex_path_bs5_V3,
                    ]
            for ex_path in tests:
                ex_run = ExRun(ex_path)
                ex_run.ex_type._plot_force_gauge_displacement(p, linewidth=2.)
...
#                ex_run.ex_type._plot_force_machine_displacement_wo_elast_interpolated(p, linewidth=2.5)
        ...
        #
        K_linear = 1 / 1.014  # [MN/m] bending stiffness with respect to a force applied at center of the beam
