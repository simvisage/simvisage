...
class LC( HasTraits ):
    ...
    def _read_data( self, file_name ):
        ...
        input_arr = loadtxt( file_name, skiprows = 1, delimiter = ";" )
    ...
    sr_columns = List( ['Px', 'Py', 'Pz', 'Mx', 'My', 'Mz'] )
    geo_columns = List( [] )
...
#                             'column_2' )
    ...
    lc_list = [
                 ...
                 LC( name = 'Q_corner', category = 'imposed-load',
                     ...
                     exclusive_to = ['Q_edge', 'WF', 'w_int', 'w_asym', 'w_pos', 'w_neg', 's_asym', 's_sym', 'T_pos', 'T_neg', 'T_shrinkage'],
                 ...
                 LC( name = 'Q_edge', category = 'imposed-load',
                     ...
                     exclusive_to = ['Q_corner', 'WF', 'w_int', 'w_asym', 'w_pos', 'w_neg', 's_asym', 's_sym', 'T_pos', 'T_neg', 'T_shrinkage'],
                     psi_0 = 0.0, psi_1 = 0.0, psi_2 = 0.0
                    ),
                 ...
                 # LC13:
                 # water filling:
                 # combination coefficients for accidental loading case
                 #
#                 LC( name = 'WF', category = 'imposed-load',
#                     file_name = os.path.join( data_dir, 'LC13.csv' ),
#
#                     # gamma_unf_A (=accidental)
#                     #
#                     gamma_unf = 1.00,
#
#                     # first additional imposed load is multiplied with psi_1
#                     # second additional loads are multiplied with psi_2
#                     # 'w_asym', 'w_pos', 'w_neg', 'T_pos', 'T_neg', 'T_shrinkage'
#
#                     exclusive_to = ['Q_corner', 'Q_edge', 'w_int', 's_asym', 's_sym'],
#                     psi_0 = 0.8, psi_1 = 0.7, psi_2 = 0.5 ),
