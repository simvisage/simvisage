    ...
    if do == 'predimensioning':
        ...
        lc_list = [
            ...
            LC(name='s_rechts', category='imposed-load', file_name='LC6.txt',
               exclusive_to=[
                   's_hinten', 's_feld', 's_vorne', 's_links', 's_komplett'],
               psi_0=0.5, psi_1=0.2, psi_2=0.0
               ),
            # LC7:
    ...
    if do == 'dimensioning':
        ...
        lc_list_Q = [
            ...
            LC(name='s_verweht_re', category='imposed-load', file_name='LC3.txt',
                    exclusive_to=[
                        's_komplett', 's_scheddach_re', 's_hinten', 's_feld'],
                    psi_0=0.5, psi_1=0.2, psi_2=0.0
               ),
            # LC4:
            ...
            LC(name='s_hinten', category='imposed-load', file_name='LC5.txt',
                    exclusive_to=[
                        's_komplett', 's_verweht_re', 's_scheddach_re'],
                    psi_0=0.5, psi_1=0.2, psi_2=0.0
               ),
            # LC6:
            ...
            LC(name='Q_hinten', category='imposed-load', file_name='LC11.txt',
                    exclusive_to=['Q_links', 'Q_mitte', 's_komplett', 's_verweht_re', 's_scheddach_re', 's_hinten', 's_feld',
                                  'w_vonrechts_komplett', 'w_vonlinks_komplett', 'w_sog_komplett', 'w_druck_komplett', 'T_schwinden'],
                    psi_0=0.0, psi_1=0.2, psi_2=0.0
               ),
            # LC12:
            LC(name='Q_mitte', category='imposed-load', file_name='LC12.txt',
                    exclusive_to=['Q_links', 'Q_hinten', 's_komplett', 's_verweht_re', 's_scheddach_re', 's_hinten', 's_feld',
                                  'w_vonrechts_komplett', 'w_vonlinks_komplett', 'w_sog_komplett', 'w_druck_komplett', 'T_schwinden'],
                    psi_0=0.0, psi_1=0.2, psi_2=0.0
               ),
            # LC13:
            LC(name='Q_links', category='imposed-load', file_name='LC13.txt',
                    exclusive_to=['Q_hinten', 'Q_mitte', 's_komplett', 's_verweht_re', 's_scheddach_re', 's_hinten', 's_feld',
                                  'w_vonrechts_komplett', 'w_vonlinks_komplett', 'w_sog_komplett', 'w_druck_komplett', 'T_schwinden'],
                    psi_0=0.0, psi_1=0.2, psi_2=0.0
               ),
