...
#---------------------------------------------------------
    ...
    #(specimens thickness = 0.6 m; internal lever 0.52m,  specimen width = 1m
    #--------------------------------------------------------
    ...
    #   C90/105, f_cd= 51 MN/m^2, F_cd = 4,83 MN/m
    m_0_Rd = 2639.
    m_90_Rd = 2639. 
...
#        np.savetxt('combi_arr_wo_temp_LCs', lct_Q.combi_arr, delimiter=';')
   ...
   # lct_Q.plot_nm_interaction(add_max_min_nm_from_file='max_min_nm_arr_LC15-18', save_fig_to_file='nm_interaction_LC1-18')
    ...
    #--------------------------------------------------------------
    #
    lct_Q.plot_eta_nm_interaction(save_fig_to_file='eta_nm_interaction_bearing_exc'),
