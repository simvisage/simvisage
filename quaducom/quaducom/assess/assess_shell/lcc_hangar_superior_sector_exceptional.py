...
#---------------------------------------------------------
    ...
    #
    # (specimens thickness = 0.45 m; internal lever 0.3367m,  specimen width = 1m ,
    # -------------------------------------------------------
    #### tensile strength [kN/m]###
    # elected textile: carbopree d_s=14mm
    # Beruecksichtigung der Langzeitfestigkeit mit dem Faktor 0.85 und gamma.tex=1.3 , f_CFK.d = 2040 MN/m^2
    # A_tex,0,vorh = 24,42 cm^2/m
    # A_tex,90,vorh = 24,42 cm^2/m 
    n_0_Rdt =  5027. 
    n_90_Rdt = 5027. #[kN/m]
       
    ### bending strength [kNm/m] ###
    ### aus iterativer QS-Bemessung mit epsilon,c=2,8 promille und epsilon,t= 9,74 promille,
    # C90/105, f_cd= 51 MN/m^2, F_cd = 3,63 MN/m, z=0,39 m 
    m_0_Rd = 1418.
    m_90_Rd = 1418. 
