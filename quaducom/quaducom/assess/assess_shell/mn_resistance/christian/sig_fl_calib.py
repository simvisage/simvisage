...
#    M_fail = Float(3.5)  # [kNm]
    M_fail = Float(3.12, sig_t_modified=True)  # [kNm]
    N_fail = Float(0.0, sig_t_modified=True)  # [kN]
    ...
    def calib_layer_response(self, u):
        ...
        self.eps_t_i_fail = eps_t_i_arr[0]
...
#        print '--- fit_response called --- %g' % ( self.m )
    ...
    def calib_sig_t_mfn(self):
        ...
        x, self.eps_t_i_arr, eps_c_i_arr, self.sig_t_mfn, self.eps_t_fail, var_a = self.layer_response(u_sol)
    ...
    def plot_ecbl_mfn_(self):
        ...
        p.plot(eps_arr, sig_t_arr, color='k', linewidth=1.5)
        p.show()
