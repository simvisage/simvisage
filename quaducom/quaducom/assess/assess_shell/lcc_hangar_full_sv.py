if __name__ == '__main__':
    ...
    #(specimens thickness = 0.6 m; internal lever 0.4373m,  specimen width = 1m
    #--------------------------------------------------------
    ### tensile strength [kN/m]###
    
    # elected textile: solidian GRID Q142/142
    # Beruecksichtigung der Langzeitfestigkeit mit dem Faktor 0.85 und gamma.tex=1.5 , f_tex,d = 1303 MN/m^2
    # elected c-bar: carbopree gamma_cfk = 1.3, f_cfk,d = 2040 MN/m^2
    
    # A_tex,0,vorh = 35.5 cm^2/m
    # A_cfk,0,vorh = 151 cm^2/m 
    n_0_Rdt = 35391. 
    
    # A_tex,90,vorh = 35.5 cm^2/m 
    # A_cfk,90,vorh = 27.72 cm^2/m
    n_90_Rdt =10277. #[kN/m]
     
    
    ### bending strength [kNm/m] ###
    ### aus iterativer QS-Bemessung mit epsilon,c=2,8 promille und epsilon,t= 6 promille,
    #   C90/105, f_cd= 51 MN/m^2, F_cd = 6.03 MN/m
    m_0_Rd = 2639.
    m_90_Rd = 2639. 
...
#        np.savetxt('combi_arr_wo_temp_LCs', lct_Q.combi_arr, delimiter=';')
   ...
   # lct_Q.plot_nm_interaction(add_max_min_nm_from_file='max_min_nm_arr_LC15-18', save_fig_to_file='nm_interaction_LC1-18')
    ...
    #--------------------------------------------------------------
    #
##    lct_Q.plot_eta_nm_interaction(save_fig_to_file='eta_nm_interaction_full_sv'),
