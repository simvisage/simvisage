...
class FETS2D4Q9U(FETSEval):
    ...
    def get_N_mtx(self,r_pnt):
        ...
        N_dof[0,0] =   (r_pnt[0] * r_pnt[1] * (-1 + r_pnt[1]) * (-1 + r_pnt[0])) / 0.4e1
        N_dof[0,1] =   (r_pnt[0] * r_pnt[1] * (-1 + r_pnt[1]) * (1 + r_pnt[0])) / 0.4e1
        N_dof[0,2] =   (r_pnt[0] * r_pnt[1] * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 0.4e1
        N_dof[0,3] =   (r_pnt[0] * r_pnt[1] * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 0.4e1
        N_dof[0,4] = -  (r_pnt[1] * (-1 + r_pnt[0]) * (1 + r_pnt[0]) * (-1 + r_pnt[1])) / 0.2e1
        N_dof[0,5] = -  (r_pnt[0] * (-1 + r_pnt[1]) * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 0.2e1
        N_dof[0,6] = -  (r_pnt[1] * (-1 + r_pnt[0]) * (1 + r_pnt[0]) * (1 + r_pnt[1])) / 0.2e1
        N_dof[0,7] = -  (r_pnt[0] * (-1 + r_pnt[1]) * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 0.2e1
        N_dof[0,8] = (-1 + r_pnt[1]) * (1 + r_pnt[1]) * (-1 + r_pnt[0]) * (1 + r_pnt[0])
    ...
    def get_dNr_mtx(self, r_pnt):
        ...
        dNr_mtx[0,0] =   (r_pnt[1] * (-1 + r_pnt[1]) * (-1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (-1 + r_pnt[1])) / 4.0
        dNr_mtx[0,1] =   (r_pnt[1] * (-1 + r_pnt[1]) * (1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (-1 + r_pnt[1])) / 4.0
        dNr_mtx[0,2] =   (r_pnt[1] * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (1 + r_pnt[1])) / 4.0
        dNr_mtx[0,3] =   (r_pnt[1] * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (1 + r_pnt[1])) / 4.0
        dNr_mtx[0,4] = - (r_pnt[1] * (-1 + r_pnt[1]) * (1 + r_pnt[0])) / 0.2e1 -  (r_pnt[1] * (-1 + r_pnt[1]) * (-1 + r_pnt[0])) / 2.0
        dNr_mtx[0,5] = - ((-1 + r_pnt[1]) * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 2.0 -  (r_pnt[0] * (-1 + r_pnt[1]) * (1 + r_pnt[1])) / 2.0
        dNr_mtx[0,6] = - (r_pnt[1] * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 2.0 -  (r_pnt[1] * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 2.0
        dNr_mtx[0,7] = - ((-1 + r_pnt[1]) * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 2.0 -  (r_pnt[0] * (-1 + r_pnt[1]) * (1 + r_pnt[1])) / 2.0
        dNr_mtx[0,8] =   (-1 + r_pnt[1]) * (1 + r_pnt[1]) * (1 + r_pnt[0]) + (-1 + r_pnt[1]) * (1 + r_pnt[1]) * (-1 + r_pnt[0])
        dNr_mtx[1,0] =   (r_pnt[0] * (-1 + r_pnt[1]) * (-1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (-1 + r_pnt[0])) / 4.0
        dNr_mtx[1,1] =   (r_pnt[0] * (-1 + r_pnt[1]) * (1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (1 + r_pnt[0])) / 4.0
        dNr_mtx[1,2] =   (r_pnt[0] * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (1 + r_pnt[0])) / 4.0
        dNr_mtx[1,3] =   (r_pnt[0] * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 4.0 +  (r_pnt[0] * r_pnt[1] * (-1 + r_pnt[0])) / 4.0
        dNr_mtx[1,4] = - ((-1 + r_pnt[0]) * (1 + r_pnt[0]) * (-1 + r_pnt[1])) / 2.0 -  (r_pnt[1] * (-1 + r_pnt[0]) * (1 + r_pnt[0])) / 2.0
        dNr_mtx[1,5] = - (r_pnt[0] * (1 + r_pnt[1]) * (1 + r_pnt[0])) / 2.0 -  (r_pnt[0] * (-1 + r_pnt[1]) * (1 + r_pnt[0])) / 2.0
        dNr_mtx[1,6] = - ((-1 + r_pnt[0]) * (1 + r_pnt[0]) * (1 + r_pnt[1])) / 2.0 -  (r_pnt[1] * (-1 + r_pnt[0]) * (1 + r_pnt[0])) / 2.0
        dNr_mtx[1,7] = - (r_pnt[0] * (1 + r_pnt[1]) * (-1 + r_pnt[0])) / 2.0 -  (r_pnt[0] * (-1 + r_pnt[1]) * (-1 + r_pnt[0])) / 2.0
        dNr_mtx[1,8] =   (-1 + r_pnt[0]) * (1 + r_pnt[0]) * (1 + r_pnt[1]) + (-1 + r_pnt[0]) * (1 + r_pnt[0]) * (-1 + r_pnt[1])
        return dNr_mtx
