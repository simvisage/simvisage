...
class FETS2D4Q12U(FETSEval):
    ...
    def get_N_mtx(self,r_pnt):
        ...
        N_mtx[0, 0] =  ((-1 + r) * (-1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        N_mtx[0, 2] = -(( 1 + r) * (-1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        N_mtx[0, 4] =  (( 1 + r) * ( 1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        N_mtx[0, 6] = -((-1 + r) * ( 1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        ...
        N_mtx[1, 1] =  ((-1 + r) * (-1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        N_mtx[1, 3] = -(( 1 + r) * (-1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        N_mtx[1, 5] =  (( 1 + r) * ( 1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
        N_mtx[1, 7] = -((-1 + r) * ( 1 + s) * (9 * s * s + 9 * r * r - 10)) / 32.
    ...
    def get_dNr_mtx(self, r_pnt):
        ...
        dNr[0, 0] =   ((-1 + s) * (9 * r * r + 9 * s * s - 10)) / 32. + 9. / 16. *  (-1 + s) *  (-1 + r) *  r
        dNr[0, 1] = - ((-1 + s) * (9 * r * r + 9 * s * s - 10)) / 32. - 9. / 16. *  (-1 + s) *  ( 1 + r) *  r
        dNr[0, 2] =   (( 1 + s) * (9 * r * r + 9 * s * s - 10)) / 32. + 9. / 16. *  ( 1 + s) *  ( 1 + r) *  r
        dNr[0, 3] = - (( 1 + s) * (9 * r * r + 9 * s * s - 10)) / 32. - 9. / 16. *  ( 1 + s) *  (-1 + r) *  r
        dNr[0, 4] = -9./32. *  (3 * r - 1) *  (1 + r) *  (-1 + s) - 27./ 32. *  (-1 + r) *  (1 + r) *  (-1 + s) - 9. / 32. *  (-1 + r) *  (3 * r - 1) *  (-1 + s)
        dNr[0, 5] =  9./32. *  (3 * r + 1) *  (1 + r) *  (-1 + s) + 27./ 32. *  (-1 + r) *  (1 + r) *  (-1 + s) + 9. / 32. *  (-1 + r) *  (3 * r + 1) *  (-1 + s)
        dNr[0, 6] =  9./32. *  (-1 + s) *  (3 * s - 1) *  (1 + s)
        dNr[0, 7] = -9./32. *  (-1 + s) *  (3 * s + 1) *  (1 + s)
        dNr[0, 8] = -9./32. *  (3 * r + 1) *  (1 + r) *  (1 + s) - 27./ 32. *  (-1 + r) *  (1 + r) *  (1 + s) - 9. / 32. *  (-1 + r) *  (3 * r + 1) *  (1 + s)
        dNr[0, 9] =  9./32. *  (3 * r - 1) *  (1 + r) *  (1 + s) + 27./ 32. *  (-1 + r) *  (1 + r) *  (1 + s) + 9. / 32. *  (-1 + r) *  (3 * r - 1) *  (1 + s)
        dNr[0,10] =  9./32. *  (-1 + s) *  (3 * s + 1) *  (1 + s)
        dNr[0,11] = -9./32. *  (-1 + s) *  (3 * s - 1) *  (1 + s)
        dNr[1, 0] =   ((-1 + r) * (9 * r * r + 9 * s * s - 10)) / 32. + 9. / 16. *  (-1 + s) *  (-1 + r) *  s
        dNr[1, 1] = - (( 1 + r) * (9 * r * r + 9 * s * s - 10)) / 32. - 9. / 16. *  (-1 + s) *  ( 1 + r) *  s
        dNr[1, 2] =   (( 1 + r) * (9 * r * r + 9 * s * s - 10)) / 32. + 9. / 16. *  ( 1 + s) *  ( 1 + r) *  s
        dNr[1, 3] = - ((-1 + r) * (9 * r * r + 9 * s * s - 10)) / 32. - 9. / 16. *  ( 1 + s) *  (-1 + r) *  s
        dNr[1, 4] = -9./32. *  (-1 + r) *  (3 * r - 1) *  (1 + r)
        dNr[1, 5] =  9./32. *  (-1 + r) *  (3 * r + 1) *  (1 + r)
        dNr[1, 6] =  9./32. *  (3 * s - 1) *  (1 + s) *  (1 + r) + 27./ 32. *  (-1 + s) *  (1 + s) *  (1 + r) + 9. / 32. *  (-1 + s) *  (3 * s - 1) *  (1 + r)
        dNr[1, 7] = -9./32. *  (3 * s + 1) *  (1 + s) *  (1 + r) - 27./ 32. *  (-1 + s) *  (1 + s) *  (1 + r) - 9. / 32. *  (-1 + s) *  (3 * s + 1) *  (1 + r)
        dNr[1, 8] = -9./32. *  (-1 + r) *  (3 * r + 1) *  (1 + r)
        dNr[1, 9] =  9./32. *  (-1 + r) *  (3 * r - 1) *  (1 + r)
        dNr[1,10] =  9./32. *  (3 * s + 1) *  (1 + s) *  (-1 + r) + 27./ 32. *  (-1 + s) *  (1 + s) *  (-1 + r) + 9. / 32. *  (-1 + s) *  (3 * s + 1) *  (-1 + r)
        dNr[1,11] = -9./32. *  (3 * s - 1) *  (1 + s) *  (-1 + r) - 27./ 32. *  (-1 + s) *  (1 + s) *  (-1 + r) - 9. / 32. *  (-1 + s) *  (3 * s - 1) *  (-1 + r)
        return dNr
