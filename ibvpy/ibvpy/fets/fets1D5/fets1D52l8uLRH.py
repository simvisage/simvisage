...
class FETS1D52L8ULRH(FETSEval):
    ...
    def get_B_mtx(self, r, X):
        ...
        B_mtx = array([[dN[0], 0, dN[3], 0, 0, 0, 0, 0, dN[1], 0, dN[2], 0, 0, 0, 0, 0], # eps_1
                       [ N[0], 0, N[3], 0, -N[3], 0, -N[0], 0, N[1], 0, N[2], 0, -N[2], 0, -N[1], 0], # slip
                       [    0, N[0], 0, N[3], 0, -N[3], 0, -N[0], 0, N[1], 0, N[2], 0, -N[2], 0, -N[1]], # opening
                       [    0, 0, 0, 0, dN[3], 0, dN[0], 0, 0, 0, 0, 0, dN[2], 0, dN[1], 0] # eps_2
                       ], dtype = float_)
        return B_mtx
