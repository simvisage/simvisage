...
from etsproxy.traits.api import \
    ...
    Callable, Dict, Tuple, Class, Str, Enum, on_trait_change, Bool, Any, \
    Event
...
from numpy import \
    ...
    logical_and, argwhere, ix_, ones_like, fabs, ma, logical_or, \
...
from ibvpy.api import FEGridIdxSlice, FEGridLevelSetSlice

from ibvpy.fets.fets_eval import FETSEval
from ibvpy.mesh.i_fe_parent_domain import IFEParentDomain
from ibvpy.mesh.i_fe_uniform_domain import IFEUniformDomain
from ibvpy.mesh.i_fe_grid_slice import IFEGridSlice
from ibvpy.mesh.fe_grid import FEGrid

from ibvpy.dots.subdots_eval import DOTSEval
...
class FELSDomain( FESubDomain ):
    ...
    def _get_ls_mask( self ):
        ...
        if isinstance( self.fe_grid, FEGrid ):
            ...
            parent_ls_mask = repeat( False, n_grid_elems ).reshape( self.fe_grid.shape )
        else:
    ...
    idx_mask = Property( depends_on = '+shape_changed,+ls_changed' ) # @todo define shape attribute
    @cached_property
    ...
    xelems_mask = Property( depends_on = '+shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    #    of this grid
    intg_mask = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    #
    intg_profile = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    #----------------------------------------------------------------------
    ls_grid_ix = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    intg_grid_ix = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    xelems_grid_ix = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    #-----------------------------------------------------------------------------
    ls_elem_grid = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    intg_elem_grid = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    ls_ielem_grid = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    xelems_arr_ix = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    ls_elems = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    #-------------------------------------------------------------------------------
    elem_dof_map = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    elem_xdof_map = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    # 
    ls_elem_dof_map = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    dof_enum_data = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    def _get_dof_enum_data( self ):
        ...
        '''
        # 
        ls_elem_dof_map = copy( self.fe_grid.ls_elem_dof_map[ self.ls_parent_elems ] )
        ...
        elem_xdof_map = copy( ls_elem_dof_map ).reshape( n_elems, n_nodes, n_nodal_dofs )
        elem_xdof_map = elem_xdof_map[:, :, self.fets_eval.x_slice].reshape( n_elems, n_xdofs )
    ...
    elem_X_map = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    ls_elem_X_map = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    #
    elements = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    dof_node_ls_values = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    ...
    ls_intersection_r = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    def _get_ls_intersection_r( self ):
        ...
        for elem in i_elements:
            inter_pts = []
            #X_mtx = self.elements[elem].get_X_mtx() # skips deactivated elements
    ...
    idx_active_elems = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
    def _get_idx_active_elems( self ):
        return arange( self.n_active_elems )

    n_active_elems = Property( depends_on = 'shape_changed,+ls_changed,idx_mask_changed' )
    @cached_property
