...
class FESpringArray( FESubDomain ):
    ...
    def _get_elem_dof_map( self ):
        return hstack( [ self.dofs_1[:, None], self.dofs_2[:, None] ] )
    ...
    def get_spring_forces( self, U ):
        ...
        F_arr = zeros( ( self.n_elems, ), dtype = float )
