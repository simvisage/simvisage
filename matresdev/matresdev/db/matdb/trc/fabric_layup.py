...
class FabricLayUp( SimDBClass ):
    ...
    fabric_layout_ref = Property( Instance( SimDBClass ), depends_on = 'fabric_layout_key' )
    @cached_property
    ...
    orientation_fn_ref = Property( Callable, unit = 'degree', depends_on = 'input_change' )
    @cached_property
    ...
    orientation_list = Property( List( Int, unit = 'degree' ), depends_on = 'input_change' )
    @cached_property
