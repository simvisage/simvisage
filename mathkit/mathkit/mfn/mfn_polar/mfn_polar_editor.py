...
#from etsproxy.enable.wx_backend.api import Window                                                   <=== Unchange
...
#from etsproxy.chaco.tools.api import SimpleZoom, DataLabelTool                                    <=== Unchange
...
def coord_trans_plt(r_value, frac_noplot, plotrange_min, plotrange_max):
    ...
    if r_value < plotrange_min :
        ...
        r_value_plt = r_a + \
                     (1. - r_a) * \
                     (r_value - plotrange_min) / (plotrange_max - plotrange_min)
    return r_value_plt
